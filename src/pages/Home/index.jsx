...
function Index() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#f8f8f8]">
      <div className="max-w-md px-4 py-10 mx-auto sm:max-w-lg md:max-w-2xl sm:px-6">
        {/* SAVE THE DATE */}
        ...
        <div className="flex flex-col items-center justify-center w-full px-8">
          ...
          <p className="text-2xl font-bold text-[#9e0e00] text-center my-5">
            &
          </p>
        ...
        <div className="flex items-center justify-between w-full gap-2 ">
          ...
          <div className="w-full px-5 ">
            <p className="text-3xl font-bold text-[#9e0e00] ">
            ...
            <div className="flex justify-center w-full md:justify-start"></div>

            <div className="flex items-center w-full gap-2.5 my-5 ">
              <img src={Pernik2} alt="pernik2" className="w-15 rotate-15" />

              <div className="">
                <p className="text-xl font-bold text-[#9e0e00]  ">
